<script lang="ts">
  ...
  onMount(() => {
    ...
    const algoliaSearchBox = searchBox({
      ...
      cssClasses: {
        input:
          "w-full outline-none appearance-none border-1 rounded-sm pl-4 py-2 border-neutral-500 relative bg-neutral-800",
...
>
  ...
  <div class="w-3/6 z-[55] bg-neutral-700" transition:fly={{ y: 200, duration: 200, easing, delay: 0.2 }}>
