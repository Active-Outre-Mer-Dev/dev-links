...
>
  <div class="w-4/5 justify-between flex items-center h-full">
    ...
    <div class="flex items-center justify-center h-full gap-4">
      ...
      >
        <div class="space-x-2 text-neutral-400">
          <svg
        ...
        <div class="text-neutral-300">
          <kbd class="bg-neutral-800 p-1 w-5 h-5 text-xs rounded-sm uppercase">Ctrl</kbd>
          <kbd class="bg-neutral-800 p-1 w-5 h-5 text-xs rounded-sm">K</kbd>
        </div>
      </button>
      <ThemeToggle />
    </div>
